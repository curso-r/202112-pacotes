...
#https://github.com/curso-r/202112-pacotes/tree/main/exemplos_de_aula
pasta <- "exemplos_de_aula/"
knitr::kable(
  tibble::tibble(
    nome = "pacote_exemplo",
    link = "https://github.com/curso-r/202112-pacotes/tree/main/exemplos_de_aula",
    script = glue::glue("[{nome}]({link})")
  ) %>%
    dplyr::select(script)
)
```
...
```{r}
tibble::tibble(
  arquivos = CursoRutils:::list_github_files(params$main_repo, "resolucao_exercicios/", ".R"),
  link = paste0("https://curso-r.github.io/", params$main_repo, "/", arquivos),
  resolucao = glue::glue("[{arquivos}]({link})")
) %>%
